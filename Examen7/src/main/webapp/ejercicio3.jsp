					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								ArrayList<Jugador> jugadores = connexion.dameJugadores();
								%>
								<form action="operations.jsp?opt=delJugador" method="post">
									<select name="codJugador">
										<%
											for (Jugador j: jugadores){
												out.print("<option value=\""+j.getCodigo()+"\">"+j.getNombre()+"</option>");
											}
										%>
									</select>
									<br>

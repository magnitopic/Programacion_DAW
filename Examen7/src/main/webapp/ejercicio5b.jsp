	...
	<div id="page-wrapper">
		...
		<div class="container">
			<div id="content">
				...
				Equipo equipo = connexion.getEquipo(request.getParameter("nombre"));
				String[] divisiones = { "Central", "Atlantic", "SouthWest", "Pacific", "SouthEast", "NorthWest" };
				String[] conferencias = { "West", "East" };
				%>


				<form action="operations.jsp?opt=modEquipo&name=<%out.print(equipo.nombre); %>" method="post">
					<input type="text" name="ciudad" id="" placeholder="ciudad" value=" <% out.print(equipo.getCiudad()); %> ">
					<select name="divisione" id="">
						<%
						for (String i : divisiones) {
							if (i.equalsIgnoreCase(equipo.getDivision()))
								out.print("<option selected=\"selected\"  value=\"" + i + "\">" + i + "</option>");
							else
								out.print("<option value=\"" + i + "\">" + i + "</option>");
						}
						%>
					</select> <select name="conferencia" id="">
						<%
						for (String i : conferencias) {
							if (i.equalsIgnoreCase(equipo.getConferencia()))
								out.print("<option selected=\"selected\"  value=\"" + i + "\">" + i + "</option>");
							else
								out.print("<option value=\"" + i + "\">" + i + "</option>");
						}
